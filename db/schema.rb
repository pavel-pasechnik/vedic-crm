...
ActiveRecord::Schema[8.0].define(version: 2025_06_06_073047) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.index ["class_schedule_id", "student_profile_id"], name: "index_attendances_on_class_schedule_id_and_student_profile_id", unique: true
  end
  ...
  create_table "certificate_template_entries", force: :cascade do |t|
    ...
    t.index ["certificate_template_font_id"], name: "index_certificate_template_entries_on_font_id"
    t.index ["certificate_template_id"], name: "index_certificate_template_entries_on_template_id"
  end
  ...
  create_table "certificate_template_fonts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_certificate_template_fonts_on_name", unique: true
  end
  ...
  create_table "certificate_template_images", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["certificate_template_id"], name: "index_certificate_template_images_on_certificate_template_id"
    t.index ["signature_id"], name: "index_certificate_template_images_on_signature_id"
  end
  ...
  create_table "certificate_templates", force: :cascade do |t|
    ...
    t.index ["institution_id"], name: "index_certificate_templates_on_institution_id"
  end
  ...
  create_table "certificates", force: :cascade do |t|
    ...
    t.index ["academic_group_id"], name: "index_certificates_on_academic_group_id"
    t.index ["certificate_template_id"], name: "index_certificates_on_certificate_template_id"
    t.index ["serial_id"], name: "index_certificates_on_serial_id", unique: true
  ...
  create_table "examination_results", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["examination_id"], name: "index_examination_results_on_examination_id"
    t.index ["student_profile_id"], name: "index_examination_results_on_student_profile_id"
  end
  ...
  create_table "programs_questionnaires", force: :cascade do |t|
    ...
    t.index ["program_id", "questionnaire_id"], name: "index_programs_questionnaires_on_p_and_q", unique: true
  end
  ...
  create_table "study_applications", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["person_id"], name: "index_study_applications_on_person_id", unique: true
  end
  ...
  create_table "unsubscribes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email", "code"], name: "index_unsubscribes_on_email_and_code", unique: true
    t.index ["person_id"], name: "index_unsubscribes_on_person_id"
  end
